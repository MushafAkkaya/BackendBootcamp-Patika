...
namespace BookingApp.WebApi.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        // -> Firewall ve benzeri uygulamalarımız url'i loglar, böyle bir durumda da şifrenizi loglar.
        // Güvenlik açığı
        ...
        public IActionResult Login(LoginRequest request)
        {
            ...
            var configuration = HttpContext.RequestServices.GetRequiredService<IConfiguration>(); // Dependency Injection
